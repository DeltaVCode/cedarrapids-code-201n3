...
This is a pair programming lab. One person from the pair will create a new repo and copy from the starter-code all of the files necessary to complete the project.
